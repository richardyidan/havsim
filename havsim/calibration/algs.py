...
def makeplatoon341(platooninfo, leaders, simcount, curlead, totfollist, followers, curleadlist, *args, n=10, graphtype = 'digraph'):
#	input:
#    meas, (see function makeplatooninfo)
#
#    platooninfo, (see function makeplatooninfo) - note that makeplatoon will modify the last argument of platooninfo; which is only used for makeplatoon
...
def makeplatoonlist(data, n=1, form_platoons = True, extra_output = False,lane= None, vehs = None):
    ...
    while simcount > 0:
        ...
        platooninfo, leaders, simcount, curlead, totfollist, followers, curleadlist, platoons = makeplatoon342(platooninfo, leaders, simcount, curlead, totfollist, 
                                                                                                            followers, curleadlist, meas, platooninfo, n=n)
