...
#print('loss for all human scenario is '+str(totreward)+' starting from initial with '+str(testenv.simlen)+' maximum timesteps')
#totreward = testenv.simulate_baseline(FS,[2,.4,.4,3,3,7,15,2]) #control model
#print('loss for one AV with parametrized control is '+str(totreward)+' starting from initial with '+str(testenv.simlen)+' maximum timesteps')
