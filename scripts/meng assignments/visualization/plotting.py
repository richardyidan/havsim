...
with open('plottingtesting.pkl','rb') as f: 
    meas, platooninfo, platoonlist, sim = pickle.load(f)

vehlist = []
[vehlist.extend(i[1:]) for i in platoonlist]

#from calibration import platoonplot 
...
#%%
#from calibration import animatevhd, animatevhd_list
"""
TO DO 
...
#%%
#from calibration import animatetraj
"""
TO DO 
